...
- **Challenges:**
  1. Time management, however, I did find a what seems to be super useful tool to help me achieve this better. It's called Notion and I got it from reading [@codingyuri](https://twitter.com/codingyuri)'s blog post about her growth on Tech Twitter [here](https://yurilee.hashnode.dev/i-got-25k-followers-and-a-job-at-hashnode-within-2-months-in-tech-twitter-my-advice#time-management).
